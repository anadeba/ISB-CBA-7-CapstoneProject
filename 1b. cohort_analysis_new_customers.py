...
df2 = pd.DataFrame(columns= ['CustomerStartDate', 'return30','return60','return90', 'return120', 'return150','return180', 'return210','return240','return270', 'return300','return330', 'return360', 'results390', 'results420', 'results450', 'results480', 'results510', 'results540'])
d = '2015-04-01'
for d in dt_lst:
    start = time.time()
    ...
    df1 = pd.DataFrame([[d, results30, results60, results90, results120, results150, results180, results210, results240, results270, results300, results330, results360, results390, results420, results450, results480, results510, results540]], columns=['CustomerStartDate', 'return30', 'return60', 'return90', 'return120', 'return150', 'return180', 'return210', 'return240', 'return270', 'return300', 'return330', 'return360', 'results390', 'results420', 'results450', 'results480', 'results510', 'results540'])
    df2 = df2.append(df1)
    df2.to_csv("X:\ISB\Capstone\Data\phase2 data\SmallData\cohort.csv")
